...
def seed_face_prompts(genre, stdout):
    prompts = [
        ...
        {'text_en': 'Pretend you just ate something sour', 'text_fr': 'Fais comme si tu venais de manger quelque chose d\'acide', 'text_es': 'Imagina que acabas de comer algo agrio', 'age_group': 'all', 'category': 'sensations'},
        {'text_en': 'Show your happiest smile', 'text_fr': 'Montre ton plus beau sourire', 'text_es': 'Muestra tu sonrisa más feliz', 'age_group': 'all', 'category': 'emotions'},
        {'text_en': 'Look surprised!', 'text_fr': 'Aie l\'air surpris!', 'text_es': '¡Parece sorprendido!', 'age_group': 'all', 'category': 'emotions'},
        {'text_en': 'Look like a brave superhero', 'text_fr': 'Prends l\'air d\'un super-héros courageux', 'text_es': 'Parece un superhéroe valiente', 'age_group': '7-10', 'category': 'characters'},
        {'text_en': 'Show your sleepiest face', 'text_fr': 'Montre ton air le plus fatigué', 'text_es': 'Muestra tu cara más soñolienta', 'age_group': '3-6', 'category': 'sensations'},
        {'text_en': 'Make a grumpy face like a grouchy bear', 'text_fr': 'Fais la tête comme un ours grognon', 'text_es': 'Pon cara de gruñón como un oso enfadado', 'age_group': '3-6', 'category': 'emotions'},
        {'text_en': 'Show your scariest monster face!', 'text_fr': 'Montre ton visage de monstre le plus effrayant!', 'text_es': '¡Muestra tu cara de monstruo más aterradora!', 'age_group': '7-10', 'category': 'emotions'},
        {'text_en': 'Look as sad as a rainy day', 'text_fr': 'Aie l\'air aussi triste qu\'un jour de pluie', 'text_es': 'Ponte tan triste como un día lluvioso', 'age_group': 'all', 'category': 'emotions'},
        {'text_en': 'Make your angriest face!', 'text_fr': 'Fais ta tête la plus fâchée!', 'text_es': '¡Pon tu cara más enfadada!', 'age_group': '3-6', 'category': 'emotions'},
        {'text_en': 'Roar like a lion!', 'text_fr': 'Rugis comme un lion!', 'text_es': 'Ruge como un león!', 'age_group': '3-6', 'category': 'animals'},
        {'text_en': 'Pretend to be a robot', 'text_fr': 'Fais comme si tu étais un robot', 'text_es': 'Imagina que eres un robot', 'age_group': '7-10', 'category': 'technical'},
        {'text_en': 'Act like you are stuck in traffic', 'text_fr': 'Fais comme si tu étais coincé dans les embouteillages', 'text_es': 'Actúa como si estuvieras atrapado en el tráfico', 'age_group': 'all', 'category': 'situations'},
        {'text_en': 'Make a face like a noodle monster', 'text_fr': 'Fais une tête de monstre nouille', 'text_es': 'Pon cara de monstruo de fideos', 'age_group': 'all', 'category': 'absurd'},
        {'text_en': 'Pose like a famous movie star', 'text_fr': 'Prends la pose d\'une star de cinéma', 'text_es': 'Posa como una estrella de cine famosa', 'age_group': '7-10', 'category': 'characters'},
        {'text_en': 'Make a face like you are riding a roller coaster', 'text_fr': 'Fais la tête comme si tu faisais des montagnes russes', 'text_es': 'Pon cara como si estuvieras en una montaña rusa', 'age_group': '7-10', 'category': 'sensations'},
        {'text_en': 'Look like a cow chewing gum', 'text_fr': 'Aie l\'air d\'une vache qui mâche du chewing-gum', 'text_es': 'Parece una vaca masticando chicle', 'age_group': '3-6', 'category': 'animals'},
        {'text_en': 'Pretend your phone is ringing', 'text_fr': 'Fais comme si ton téléphone sonnait', 'text_es': 'Imagina que tu teléfono está sonando', 'age_group': 'all', 'category': 'situations'},
        {'text_en': 'Make a silly robot dance face', 'text_fr': 'Fais une tête de robot qui danse', 'text_es': 'Pon cara de robot bailando', 'age_group': '3-6', 'category': 'technical'},
        {'text_en': 'Look like a grumpy grandpa', 'text_fr': 'Aie l\'air d\'un grand-père grincheux', 'text_es': 'Parece un abuelo gruñón', 'age_group': 'all', 'category': 'characters'},
        {'text_en': 'Make a face like you swallowed a bug', 'text_fr': 'Fais comme si tu avais avalé un insecte', 'text_es': 'Pon cara como si te hubieras tragado un bicho', 'age_group': 'all', 'category': 'absurd'},
    ]
    count = 0
    for p in prompts:
